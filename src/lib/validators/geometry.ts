...
export type Point2D = z.infer<typeof pointSchema>
...
export const polygon2dV1Schema = z.object({
  ...
  points: z.array(pointSchema).min(3, 'Polígono precisa de pelo menos 3 vértices'),
   ...
   * ALTER TABLE pass.
   */
  extrude_height: z.number().nullable().optional(),
...
export type Polygon2DGeometry = z.infer<typeof polygon2dV1Schema>
...
export const geometrySchema = z.discriminatedUnion('type', [polygon2dV1Schema])
 ...
 */
export function computePolygonArea(points: Array<readonly [number, number]>): number {
 ...
 */
export function computeGeometryAreaM2(geometry: Geometry): number {
