...
exports.consentRecords = (0, pg_core_1.pgTable)('consent_records', {
    ...
    consentText: (0, pg_core_1.text)('consent_text').notNull().default(''),
    ...
    grantedScopes: (0, pg_core_1.jsonb)('granted_scopes'),
    consentAt: (0, pg_core_1.timestamp)('consent_at', { withTimezone: true }).defaultNow().notNull(),
