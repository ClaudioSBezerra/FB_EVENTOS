...
exports.tenants = (0, pg_core_1.pgTable)('tenants', {
     ...
     */
    platformCommissionPct: (0, pg_core_1.numeric)('platform_commission_pct', { precision: 5, scale: 4 })
        .notNull()
        .default('0.0500'),
    /**
     ...
     */
    vendorAutoApprove: (0, pg_core_1.boolean)('vendor_auto_approve').notNull().default(false),
    /**
     ...
     */
    refundPolicyJson: (0, pg_core_1.jsonb)('refund_policy_json'),
...
}, (table) => [(0, pg_core_1.index)('tenants_deleted_at_idx').on(table.deletedAt)]);
